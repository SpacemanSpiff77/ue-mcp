...
void FBlueprintHandlers::RegisterHandlers(FMCPHandlerRegistry& Registry)
{
	...
	Registry.RegisterHandlerWithTimeout(TEXT("read_blueprint_function_topology"), &ReadBlueprintFunctionTopology, ReadBlueprintGraphTimeoutSeconds);
	...
	Registry.RegisterHandlerWithTimeout(TEXT("qualify_call_function_candidates"), &QualifyCallFunctionCandidates, 600.0f);
